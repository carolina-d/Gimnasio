...
namespace InfraestructuraBase.Repositorios
{
    public class Repositorio<TEntidad> : IRepositorio<TEntidad> where TEntidad : Entidad
    {
        ...
        public TEntidad ObtenerPorId(long entidadId)
        {
        ...
        public TEntidad ObtenerPorId(long entidadId, string propiedadNavegacion = "")
        {
