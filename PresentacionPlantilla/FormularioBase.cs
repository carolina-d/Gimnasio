...
namespace PresentacionPlantilla
{
    public partial class FormularioBase : Form
    {
        ...
        {
            set { this.pnlSuperior.BackColor = value.HasValue ? value.Value : Color.SteelBlue; }
        }

        public Color? ColorTitulo
        {
            set { this.lblTitulo.ForeColor = value.HasValue ? value.Value : Color.White; }
        }

        public Color? ColorLeyenda
        {
            set { this.lblLeyenda.ForeColor = value.HasValue ? value.Value : Color.White; }
        }
        ...
        public void textBoxLetrasySimbolos_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        public void textBox_Validated(object sender, EventArgs e)
        {
            ...
            {
                errorProvider.SetError(txt, Constante.Mensaje.DatoObligatorio);
