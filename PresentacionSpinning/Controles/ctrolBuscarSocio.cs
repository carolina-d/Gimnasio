...
namespace PresentacionSpinning.Controles
{
    public partial class ctrolBuscarSocio : UserControl
    {
        ...
        private void btnBuscarSocio_Click(object sender, EventArgs e)
        {
            ...
            var resultado = _socioUow.DatoSocioRepositorio.ObtenerPorFiltro(
                x => (x.Telefono.Contains(this.txtTelefono.Text) ||
                      x.Apellido.Contains(this.txtApyNom.Text)) && x.Id != 1);
